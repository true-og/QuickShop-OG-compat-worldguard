...
public final class Main extends CompatibilityModule implements Listener {
    ...
    public void onLoad() {
        ...
        try {
            ...
            StateFlag createFlag = new StateFlag("quickshop-og-create",
                    getConfig().getBoolean("create.default-allow", false));
            StateFlag tradeFlag = new StateFlag("quickshop-og-trade",
            ...
            // check type
            Flag<?> existing = registry.get("quickshop-og-create");
            ...
            existing = registry.get("quickshop-og-trade");
